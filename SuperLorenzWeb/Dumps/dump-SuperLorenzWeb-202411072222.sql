...
(1,'Jamón Ibérico','Jamón empacado ibérico','Carnes','Zenú'),
(2,'Leche Entera','Leche de vaca entera en caja','Lácteos','Alpina'),
(3,'Queso Mozzarella','Queso mozzarella rallado','Lácteos','Colanta'),
(4,'Cereal Integral','Cereal con hojuelas integrales de maíz','Cereales','Kelloggs'),
(5,'Arroz Blanco','Arroz blanco tipo exportación','Granos','Diana'),
(6,'Aceite de Girasol','Aceite 100% de girasol','Aceites','Premier'),
(7,'Pan Integral','Pan de trigo integral en tajadas','Panadería','Bimbo'),
(8,'Café Molido','Café molido suave','Bebidas','Juan Valdez'),
(9,'Atún en Aceite','Atún en aceite vegetal','Enlatados','Van Camps'),
(10,'Galletas Integrales','Galletas de avena y miel','Snacks','Quaker'),
(11,'Detergente Líquido','Detergente líquido para ropa','Limpieza','Ariel'),
(12,'Papel Higiénico','Papel higiénico de 4 rollos','Hogar','Familia'),
(13,'Jabón Antibacterial','Jabón en barra antibacterial','Higiene','Protex'),
(14,'Avena en Hojuelas','Hojuelas de avena sin azúcar','Cereales','La Niña'),
(15,'Gaseosa de Naranja','Gaseosa sabor naranja','Bebidas','Postobón'),
(16,'Salsa de Tomate','Salsa de tomate 500g','Salsas','Heinz'),
(17,'Mantequilla','Mantequilla con sal','Lácteos','La Vaquita'),
(18,'Lentejas','Lentejas secas 500g','Granos','Del Campo'),
(19,'Aguacate','Aguacate hass fresco','Frutas','Organico'),
(20,'Plátano Maduro','Plátano maduro orgánico','Frutas','Frutos del Sol'),
(21,'Yogur Natural','Yogur sin azúcar y sin sabor','Lácteos','Alpina'),
(22,'Limón Tahití','Limón tahití fresco','Frutas','La Finca'),
(23,'Huevos AA','Huevos frescos AA','Proteínas','Kikes'),
(24,'Queso Campesino','Queso fresco campesino','Lácteos','Colanta'),
(25,'Ajo Triturado','Ajo triturado en conserva','Condimentos','La Comadre'),
(26,'Gelatina de Fresa','Gelatina de fresa lista para preparar','Postres','Royal'),
(27,'Azúcar Refinada','Azúcar refinada blanca','Granos','Incauca'),
(28,'Café Descafeinado','Café instantáneo descafeinado','Bebidas','Nescafé'),
(29,'Mermelada de Fresa','Mermelada de fresa sin conservantes','Dulces','La Constancia'),
(30,'Harina de Trigo','Harina de trigo para todo uso','Panadería','Haz de Oros'),
(31,'Galletas de Chocolate','Galletas rellenas de chocolate','Snacks','Festival'),
(32,'Agua Embotellada','Agua mineral sin gas','Bebidas','Brisa'),
(33,'Salchichón Ahumado','Salchichón ahumado y empacado','Carnes','Zenú'),
(34,'Chocolate en Polvo','Chocolate en polvo para bebidas','Dulces','Luker'),
(35,'Crema de Leche','Crema de leche pasteurizada','Lácteos','Alpina'),
(36,'Margarina','Margarina para cocinar','Grasas','La Fina'),
(37,'Gaseosa de Cola','Gaseosa sabor cola','Bebidas','Coca-Cola'),
(38,'Vinagre Blanco','Vinagre de alcohol blanco','Condimentos','La Constancia'),
(39,'Limpiador Multiusos','Limpiador líquido para superficies','Limpieza','Fabuloso'),
(40,'Champú Anticaspa','Champú anticaspa con mentol','Higiene','Head & Shoulders'),
(41,'Pasta de Dientes','Pasta dental con flúor','Higiene','Colgate'),
(42,'Frijoles Rojos','Frijoles secos para cocinar','Granos','Del Campo'),
(43,'Jugo de Naranja','Jugo de naranja natural en botella','Bebidas','Florida'),
(44,'Huevos Orgánicos','Huevos frescos de granja','Proteínas','Huevos Oro'),
(45,'Mayonesa','Mayonesa en presentación de 500g','Salsas','Hellmanns'),
(46,'Maní Salado','Maní salado en bolsa','Snacks','La Especial'),
(47,'Helado de Vainilla','Helado de vainilla en pote de 1L','Postres','Popsy'),
(48,'Detergente en Polvo','Detergente en polvo para ropa','Limpieza','Ariel'),
(49,'Cebolla Blanca','Cebolla blanca fresca','Verduras','Organico'),
(50,'Espaguetis','Pasta tipo espagueti','Pasta','Doria');
...
-- Dump completed on 2024-11-07 22:22:14
